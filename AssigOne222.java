...
public class AssigOne222 {
    public static void main(String[] args) {
        ...
        for (int i = 90; i <= 180; i++) {
            laserChargingTime = i * CHARGETIME;
        }

        // calculate the time it will take for the missile to leave that position
        ...
        // // sets current time to original + how long it's taken for laser to get to
        // position i
        // currentTime.addSeconds(laserTime);

        // // make firing solution and fire laser
        // FiringSolution fireLaser = new FiringSolution(currentTime, i, missileX,
        // missileY);
